      ...
      <section className="relative py-32 bg-gray-50 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-500 max-w-3xl mx-auto font-light leading-relaxed">
            Nacimos con una misión clara: revolucionar el cuidado dental
            ofreciendo una alternativa natural, deliciosa y científicamente
            probada.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl font-black tracking-tight mb-6">
                Más que unos cristales que llevan xilitol, un compromiso con tu
                salud
              </h2>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                En CRACX, creemos que cuidar tu sonrisa no debería ser una tarea
                aburrida. Por eso, hemos desarrollado cristales que llevan
                xilitol puro que no solo previenen la caries, sino que también
                ofrecen una experiencia de sabor inigualable.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                Nuestro equipo de expertos en salud dental y nutrición trabaja
                incansablemente para asegurar que cada producto CRACX cumpla con
                los más altos estándares de calidad y eficacia.
              </p>
            </div>
